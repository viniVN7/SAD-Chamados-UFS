...
SELECT C.ID_CHAMADO, C.TITULO, C.PRIORIDADE, C.DATA_ABERTURA, C.DATA_FECHAMENTO, S.STATUS, CA.CATEGORIA, O.SIGLA AS 'ORGAO_RESPONSAVEL'
...
ON (C.ID_ORGAO_RESPONSAVEL = O.ID_ORGAO_RESPONSAVEL)
order by CATEGORIA

SELECT * FROM TB_CHAMADO

EXEC SP_CHAMADOS '17-02-2010 23:00', '20-02-2010 23:00', 1, 4, 2
