...
CREATE TABLE FATO_ORGAO_RESPONSAVEL_MES(
	ID BIGINT NOT NULL IDENTITY(1,1) PRIMARY KEY,
	MES INT NOT NULL FOREIGN KEY REFERENCES DIM_TEMPO(ID_TEMPO),
	COD_ORGAO_RESPONSAVEL INT NOT NULL FOREIGN KEY REFERENCES DIM_ORGAO_RESPONSAVEL(ID_ORGAO_RESPONSAVEL),
	STATUS INT NOT NULL FOREIGN KEY REFERENCES DIM_STATUS(ID_STATUS),
	QUANTIDADE INT NOT NULL 
)
